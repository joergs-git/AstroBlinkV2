...
struct ImageEntry: Identifiable, Hashable {
    ...
    var fitAcceptedFraction: Double?     // fraction of stars whose elliptical fit was accepted  // Median star eccentricity [0..1] from 2D image moments
    ...
    /// normalized [0,1] background median). A useful cull aid at BOTH ends: abnormally HIGH
    /// = washed-out sky (clouds / moon / light pollution); abnormally LOW = a dark/dead frame
    /// (e.g. a broken capture). Purely informational — NOT fed into quality scoring.
