...
func formatRA(_ degrees: Double) -> String {
...
func formatDec(_ degrees: Double) -> String {
    let sign = degrees >= 0 ? "+" : "-"
...
func formatSizeCompact(_ major: Double, _ minor: Double?) -> String {
    if let minor {
        if major >= 60 {
...
func formatSize(_ major: Double, _ minor: Double?) -> String {
    if let minor {
        if major >= 60 {
...
func formatArcmin(_ value: Double) -> String {
    if value >= 60 {
...
func typeIconInfo(_ type: String) -> (icon: String, color: Color) {
    switch type {
...
func filterColor(_ filter: String, nightMode: Bool) -> Color {
...
func difficultyColor(_ diff: String) -> Color {
    switch diff {
...
func weightColor(_ value: Double) -> Color {
...
func gapLevelColor(_ level: GapLevel) -> Color {
    switch level {
