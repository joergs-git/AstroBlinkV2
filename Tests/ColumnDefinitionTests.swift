...
final class ColumnDefinitionTests: XCTestCase {
    ...
    func testAllColumnIdsReturnValuesWithoutCrash() {
        ...
        entry.noiseMedian = 0.05
        entry.noiseMAD = 0.001
        entry.qualityBreakdown = QualityBreakdown(tier: .good, combinedZScore: 0.1, starsZ: nil, fwhmZ: nil, hfrZ: nil, noiseZ: nil, trailingZ: nil, snrContribution: nil, snrSquared: nil, garbageReasons: [], isLockedKeep: false, reasoningText: nil)
    ...
    func testQualityNumericValue() {
        ...
        entry.qualityBreakdown = QualityBreakdown(tier: .excellent, combinedZScore: 1.5, starsZ: nil, fwhmZ: nil, hfrZ: nil, noiseZ: nil, trailingZ: nil, snrContribution: nil, snrSquared: nil, garbageReasons: [], isLockedKeep: false, reasoningText: nil)
        ...
        entry.qualityBreakdown = QualityBreakdown(tier: .excellent, combinedZScore: 0.8, starsZ: nil, fwhmZ: nil, hfrZ: nil, noiseZ: nil, trailingZ: nil, snrContribution: nil, snrSquared: nil, garbageReasons: [], isLockedKeep: false, reasoningText: nil)
        ...
        entry.qualityBreakdown = QualityBreakdown(tier: .borderline, combinedZScore: -0.5, starsZ: nil, fwhmZ: nil, hfrZ: nil, noiseZ: nil, trailingZ: nil, snrContribution: nil, snrSquared: nil, garbageReasons: [], isLockedKeep: false, reasoningText: nil)
        XCTAssertEqual(ColumnDefinition.numericValue(for: "quality", from: entry), -0.5)

        entry.qualityBreakdown = QualityBreakdown(tier: .trash, combinedZScore: -99.0, starsZ: nil, fwhmZ: nil, hfrZ: nil, noiseZ: nil, trailingZ: nil, snrContribution: nil, snrSquared: nil, garbageReasons: [], isLockedKeep: false, reasoningText: nil)
